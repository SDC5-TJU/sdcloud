...
<div>
    ...
    <div style="width: 900px;" id="chart">
        <div id="xapian1" style="width: 550px;height: 300px; position: absolute;top: 150px;left:150px;"></div>
        <div id="xapian2" style="width: 550px;height: 300px;position: absolute; left:750px;top: 150px;"></div>
        <div id="xapian3" style="width: 550px;height: 300px;position: absolute; left:150px;top: 500px;"></div>
        <div id="xapian4" style="width: 550px;height: 300px;position: absolute; left:750px;top: 500px;"></div>
    </div>
    <!--表-->
        <div style=" width: 1100px; position: absolute; top: 850px;left: 200px;" id="table">
        <form method="post" action="" id="">
            <div class="panel admin-panel">
                <div class="panel-head"><strong class="icon-reorder">计算同无干扰下的响应对比差异:xapian</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9">${xapianBaseResult.nintyTh}</td>
                        <td style="background:#f1f5fa">${xapianResult.nintyTh}</td>
                      	<c:choose>
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9" >${xapianBaseResult.nintyFiveTh}</td>
                        <td style="background:#f1f5fa" >${xapianResult.nintyFiveTh}</td>
                        <c:choose>
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9" >${xapianBaseResult.nintyNineTh}</td>
                        <td style="background:#f1f5fa" >${xapianResult.nintyNineTh}</td>
                         <c:choose>
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9" >${xapianBaseResult.var}</td>
                        <td style="background:#f1f5fa" >${xapianResult.var}</td>
                         <c:choose>
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9" >${xapianBaseResult.mean}</td>
                        <td style="background:#f1f5fa" >${xapianResult.mean}</td>
                         <c:choose>
							<c:when test="${diffBean.varDiff>0}">
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9" >${xapianBaseResult.min}</td>
                        <td style="background:#f1f5fa" >${xapianResult.min}</td>
                         <c:choose>
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9" >${xapianBaseResult.max}</td>
                        <td style="background:#f1f5fa" >${xapianResult.max}</td>
                         <c:choose>
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9" >${xapianBaseResult.missRate}</td>
                        <td style="background:#f1f5fa" >${xapianResult.missRate}</td>
                         <c:choose>
                    ...
                    <tr>
                        ...
                        <td style="background:#f9f9f9" >${xapianBaseResult.EA}</td>
                        <td style="background:#f1f5fa" >${xapianResult.EA}</td>
                         <c:choose>
